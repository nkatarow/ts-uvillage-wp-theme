...
<div role="main" class="style-guide">
    <header class="container">
        ...
        <ol>
            ...
            <li>
                <a href="#grouping">Text Grouping</a>
                <ol>
                    <li><a href="#paragraphs">Paragraphs</a></li>
                    <li><a href="#horizontal-rules">Horizontal Rules</a></li>
                    <li><a href="#pre">Pre-formated Text</a></li>
                    <li><a href="#blockquote">Blockquotes</a></li>
                    <li><a href="#ol">Ordered Lists</a></li>
                    <li><a href="#ul">Unordered Lists</a></li>
                    <li><a href="#dl">Definition Lists</a></li>
                    <li><a href="#figures">Figures</a></li>
                </ol>
            </li>
            <li>
                <a href="#text-semantics">Text Level Semantics</a>
                <ol>
                    <li><a href="#links">Links and anchors</a></li>
                    <li><a href="#em">Stressed emphasis</a></li>
                    <li><a href="#strong">Strong importance</a></li>
                    <li><a href="#small">Small print</a></li>
                    <li><a href="#s">Strikethrough</a></li>
                    <li><a href="#cite">Citations</a></li>
                    <li><a href="#q">Inline quotes</a></li>
                    <li><a href="#dfn">Definition</a></li>
                    <li><a href="#abbr">Abbreviation</a></li>
                    <li><a href="#time">Time</a></li>
                    <li><a href="#code">Code</a></li>
                    <li><a href="#var">Variable</a></li>
                    <li><a href="#samp">Sample output</a></li>
                    <li><a href="#kbd">Keyboard entry</a></li>
                    <li><a href="#sup">Superscript and subscript text</a></li>
                    <li><a href="#i">Italicised</a></li>
                    <li><a href="#b">Emboldend</a></li>
                    <li><a href="#mark">Marked or highlighted text</a></li>
                    <li><a href="#del">Edits</a></li>
                </ol>
            </li>
    ...
    <section id="grouping">
        ...
        <h3 id="horizontal-rules">Horizontal rule</h3>
    ...
    <section id="text-semantics">
        ...
        <h3 id="links">Links and anchors</h3>
        ...
        <h3 id="sup">Superscript and subscript text</h3>
